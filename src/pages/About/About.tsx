...
const About = () => {
    ...
    const visibleMembers = teamMembers.slice(startIndex, startIndex + VISIBLE_COUNT);
        ...
        <div className="about-container">
            ...
            <section className="our-team">
                <Card className="team-card">
                    ...
                    <Paragraph>
                        We are a passionate team dedicated to connecting job seekers with the right opportunities and employers with the best talent.
                    </Paragraph>
                </Card>
            </section>
            ...
            <section className="learn-more-section">
                <Card className="learn-more-card">
                    ...
                    <Paragraph>
                        Our platform is built to help you post jobs, discover workers, and find new opportunities in a seamless way.
                    </Paragraph>
                </Card>
            </section>

            <section className="team-images-section">
                <Button icon={<LeftOutlined />} shape="circle" onClick={handlePrev} disabled={startIndex === 0} />

                <div className="team-cards">
                    {visibleMembers.map((member, idx) => (
                        <Card key={idx} className="member-card">
                ...
                <Button icon={<RightOutlined />} shape="circle" onClick={handleNext} disabled={startIndex + VISIBLE_COUNT >= teamMembers.length} />
            </section>
        </div>
    );
};
